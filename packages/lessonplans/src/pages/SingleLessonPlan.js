...
export default function SingleLessonPlan({footerLinks, appName}) {
    ...
    const singleLessonPlanDetailsData = [
        {
            Name: "General Information",
            Points: [
                "Subject Name : " + lessonPlan.subject,
                "Grade Level : " + lessonPlan.gradeLevel,
                "Category : " + lessonPlan.primaryCategory,
                "Board : " + lessonPlan.board,
                "Medium : " + lessonPlan.medium,
                "Organisation : " + lessonPlan.organisation,
                "Copyright : " + lessonPlan.copyright,
                "Creator : " + lessonPlan.creator,
            ],
        },
    ];
    ...
    return (
        ...
        >
            <Box bg="white" p="5">
                <VStack space="5">
                    {singleLessonPlanDetailsData && singleLessonPlanDetailsData.length > 0 ? (
                        singleLessonPlanDetailsData.map((item, index) => (
                            <Box
                                key={index}
                                borderWidth="1"
                    ...
                    <Box bg="white" p="5">
                        <H2 pb={"5"}>Related Links</H2>
                        <VStack space="2">
                            <a href={lessonPlan.artifactUrl}>Download Media</a>
                        </VStack>
                    </Box>
                </VStack>
            </Box>
